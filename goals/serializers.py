...
class GoalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Goal
        fields = [
            'id', 'user', 'goal_type', 'target_date', 'notes', 
            'is_active', 'created_at', 'updated_at', 'days_remaining'
        ]
...
class BodyMeasurementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'metric', 'metric_display', 'measurement_type', 
            'measurement_type_display', 'value', 'timestamp', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'user', 'created_at', 'updated_at']
